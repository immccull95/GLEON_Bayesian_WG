...
for (j in 1:length(model_names)){
  ...
  forecast_ys <- c(forecast_ys[1,],forecast_ys[2,])
  ...
  if(model_names[j] %in% c("Seasonal_RandomWalk","Seasonal_RandomWalk_Obs_error")){
   ...
   tiff(file = file.path("C:/Users/Mary Lofton/Dropbox/Ch5/Final_figs/",paste0(model_names[j],"_ci_log_ICPO_2015.tif")),
   ...
   plot(forecast_times[1:20],forecast_ys[1:20],type = "n",
        ...
        ylim = c(-12,10), main = "1 week ahead hindcasts - 2015")
   ...
   lims <- c(min(forecast.ci.IC.P.O[1,c(21:40)])-0.2, max(forecast.ci.IC.P.O[3,c(21:40)])+0.2)
   tiff(file = file.path("C:/Users/Mary Lofton/Dropbox/Ch5/Final_figs/",paste0(model_names[j],"_ci_log_ICPO_2016.tif")),
       width = 8, height = 6, units = "in", res = 300)
   par(mgp = c(2.3,1,0))
   plot(forecast_times[21:40],forecast_ys[21:40],type = "n",
        xlab = "",ylab = expression(paste("log(colonies", ~~L^{-1},")")),cex.lab = 2, cex.axis = 2, cex.main = 2,
        ylim = c(-12,10), main = "1 week ahead hindcasts - 2016")
   ciEnvelope(forecast_times[21:40],forecast.ci.IC.P.O[1,c(21:40)],forecast.ci.IC.P.O[3,c(21:40)],col="deepskyblue4")
   ciEnvelope(forecast_times[21:40],forecast.ci.IC.P[1,c(21:40)],forecast.ci.IC.P[3,c(21:40)],col="coral")
   ciEnvelope(forecast_times[21:40],forecast.ci.IC[1,c(21:40)],forecast.ci.IC[3,c(21:40)],col="gray")
   lines(forecast_times[21:40],det.prediction[21:40], lwd = 2)
   points(forecast_times[21:40],forecast_ys[21:40],pch = 16)
   dev.off()
  } else if(model_names[j] == "Seasonal_AR"){
   
   #ic + p + o + pa
   lims <- c(min(forecast.ci.IC.P.O.Pa[1,c(1:20)])-0.2, max(forecast.ci.IC.P.O.Pa[3,c(1:20)])+0.2)
   tiff(file = file.path("C:/Users/Mary Lofton/Dropbox/Ch5/Final_figs/",paste0(model_names[j],"_ci_log_ICPOPa_2015.tif")),
       width = 8, height = 6, units = "in", res = 300)
   par(mgp = c(2.3,1,0))
   plot(forecast_times[1:20],forecast_ys[1:20],type = "n",
        xlab = "",ylab = expression(paste("log(colonies", ~~L^{-1},")")),cex.lab = 2, cex.axis = 2, cex.main = 2,
   ...
   lims <- c(min(forecast.ci.IC.P.O.Pa[1,c(21:40)])-0.2, max(forecast.ci.IC.P.O.Pa[3,c(21:40)])+0.2)
   ...
   plot(forecast_times[21:40],forecast_ys[21:40],type = "n",
        xlab = "",ylab = expression(paste("log(colonies", ~~L^{-1},")")),cex.lab = 2, cex.axis = 2, cex.main = 2,
        ylim = c(-12,10), main = "1 week ahead hindcasts - 2016")
   ciEnvelope(forecast_times[21:40],forecast.ci.IC.P.O.Pa[1,c(21:40)],forecast.ci.IC.P.O.Pa[3,c(21:40)],col="gold")
   ciEnvelope(forecast_times[21:40],forecast.ci.IC.P.O[1,c(21:40)],forecast.ci.IC.P.O[3,c(21:40)],col="deepskyblue4")
   ciEnvelope(forecast_times[21:40],forecast.ci.IC.P[1,c(21:40)],forecast.ci.IC.P[3,c(21:40)],col="coral")
   ciEnvelope(forecast_times[21:40],forecast.ci.IC[1,c(21:40)],forecast.ci.IC[3,c(21:40)],col="gray")
   lines(forecast_times[21:40],det.prediction[21:40], lwd = 2)
   ...
   tiff(file = file.path("C:/Users/Mary Lofton/Dropbox/Ch5/Final_figs/",paste0(model_names[j],"_ci_log_ICPOPaD_2015.tif")),
        width = 8, height = 6, units = "in", res = 300)
   par(mgp = c(2.3,1,0))
   plot(forecast_times[1:20],forecast_ys[1:20],type = "n",
        xlab = "",ylab = expression(paste("log(colonies", ~~L^{-1},")")),cex.lab = 2, cex.axis = 2, cex.main = 2,
   ...
   lims <- c(min(forecast.ci.IC.P.O.Pa.D[1,c(21:40)])-0.2, max(forecast.ci.IC.P.O.Pa.D[3,c(21:40)])+0.2)
   ...
   plot(forecast_times[21:40],forecast_ys[21:40],type = "n",
        xlab = "",ylab = expression(paste("log(colonies", ~~L^{-1},")")),cex.lab = 2, cex.axis = 2, cex.main = 2,
        ylim = c(-12,10),main = "1 week ahead hindcasts - 2016")
   ciEnvelope(forecast_times[21:40],forecast.ci.IC.P.O.Pa.D[1,c(21:40)],forecast.ci.IC.P.O.Pa.D[3,c(21:40)],col="darkseagreen3")
   ciEnvelope(forecast_times[21:40],forecast.ci.IC.P.O.Pa[1,c(21:40)],forecast.ci.IC.P.O.Pa[3,c(21:40)],col="gold")
   ciEnvelope(forecast_times[21:40],forecast.ci.IC.P.O[1,c(21:40)],forecast.ci.IC.P.O[3,c(21:40)],col="deepskyblue4")
   ciEnvelope(forecast_times[21:40],forecast.ci.IC.P[1,c(21:40)],forecast.ci.IC.P[3,c(21:40)],col="coral")
   ciEnvelope(forecast_times[21:40],forecast.ci.IC[1,c(21:40)],forecast.ci.IC[3,c(21:40)],col="gray")
...
forecast_times <- forecast_times[c(4:20,24:40)]
...
for (j in 1:length(model_names)){
  ...
  det.prediction <- det.prediction[c(1:17,21:37)]
  ...
  if(model_names[j] %in% c("Seasonal_RandomWalk","Seasonal_RandomWalk_Obs_error")){
    ...
    tiff(file = file.path("C:/Users/Mary Lofton/Dropbox/Ch5/Final_figs/",paste0(model_names[j],"_ci_log_ICPO_2015_4wk.tif")),
        width = 8, height = 6, units = "in", res = 300)
    par(mgp = c(2.3,1,0))
    plot(forecast_times[1:17],forecast_ys[1:17],type = "n",
         xlab = "",ylab = expression(paste("log(colonies", ~~L^{-1},")")),cex.lab = 2, cex.axis = 2, cex.main = 2,
         ylim = c(-12,10), main = "4 week ahead hindcasts - 2015")
    ...
    lims <- c(min(forecast.ci.IC.P.O[1,c(18:34)])-0.2, max(forecast.ci.IC.P.O[3,c(18:34)])+0.2)
    tiff(file = file.path("C:/Users/Mary Lofton/Dropbox/Ch5/Final_figs/",paste0(model_names[j],"_ci_log_ICPO_2016_4wk.tif")),
        width = 8, height = 6, units = "in", res = 300)
    par(mgp = c(2.3,1,0))
    plot(forecast_times[18:34],forecast_ys[18:34],type = "n",
         xlab = "",ylab = expression(paste("log(colonies", ~~L^{-1},")")),cex.lab = 2, cex.axis = 2, cex.main = 2,
         ylim = c(-12,10), main = "4 week ahead hindcasts - 2016")
    ciEnvelope(forecast_times[18:34],forecast.ci.IC.P.O[1,c(18:34)],forecast.ci.IC.P.O[3,c(18:34)],col="deepskyblue4")
    ciEnvelope(forecast_times[18:34],forecast.ci.IC.P[1,c(18:34)],forecast.ci.IC.P[3,c(18:34)],col="coral")
    ciEnvelope(forecast_times[18:34],forecast.ci.IC[1,c(18:34)],forecast.ci.IC[3,c(18:34)],col="gray")
    lines(forecast_times[18:34],det.prediction[18:34], lwd = 2)
    points(forecast_times[18:34],forecast_ys[18:34],pch = 16)
    dev.off()
  } else if(model_names[j] == "Seasonal_AR"){
    
    #ic + p + o + pa
    lims <- c(min(forecast.ci.IC.P.O.Pa[1,c(1:17)])-0.2, max(forecast.ci.IC.P.O.Pa[3,c(1:17)])+0.2)
    tiff(file = file.path("C:/Users/Mary Lofton/Dropbox/Ch5/Final_figs/",paste0(model_names[j],"_ci_log_ICPOPa_2015_4wk.tif")),
        width = 8, height = 6, units = "in", res = 300)
    par(mgp = c(2.3,1,0))
    plot(forecast_times[1:17],forecast_ys[1:17],type = "n",
         xlab = "",ylab = expression(paste("log(colonies", ~~L^{-1},")")),cex.lab = 2, cex.axis = 2, cex.main = 2,
    ...
    lims <- c(min(forecast.ci.IC.P.O.Pa[1,c(18:34)])-0.2, max(forecast.ci.IC.P.O.Pa[3,c(18:34)])+0.2)
    ...
    plot(forecast_times[18:34],forecast_ys[18:34],type = "n",
         xlab = "",ylab = expression(paste("log(colonies", ~~L^{-1},")")),cex.lab = 2, cex.axis = 2, cex.main = 2,
         ylim = c(-12,10), main = "4 week ahead hindcasts - 2016")
    ciEnvelope(forecast_times[18:34],forecast.ci.IC.P.O.Pa[1,c(18:34)],forecast.ci.IC.P.O.Pa[3,c(18:34)],col="gold")
    ciEnvelope(forecast_times[18:34],forecast.ci.IC.P.O[1,c(18:34)],forecast.ci.IC.P.O[3,c(18:34)],col="deepskyblue4")
    ciEnvelope(forecast_times[18:34],forecast.ci.IC.P[1,c(18:34)],forecast.ci.IC.P[3,c(18:34)],col="coral")
    ciEnvelope(forecast_times[18:34],forecast.ci.IC[1,c(18:34)],forecast.ci.IC[3,c(18:34)],col="gray")
    lines(forecast_times[18:34],det.prediction[18:34], lwd = 2)
    ...
    tiff(file = file.path("C:/Users/Mary Lofton/Dropbox/Ch5/Final_figs/",paste0(model_names[j],"_ci_log_ICPOPaD_2015_4wk.tif")),
        width = 8, height = 6, units = "in", res = 300)
    par(mgp = c(2.3,1,0))
    plot(forecast_times[1:17],forecast_ys[1:17],type = "n",
         xlab = "",ylab = expression(paste("log(colonies", ~~L^{-1},")")),cex.lab = 2, cex.axis = 2, cex.main = 2,
    ...
    lims <- c(min(forecast.ci.IC.P.O.Pa.D[1,c(18:34)])-0.2, max(forecast.ci.IC.P.O.Pa.D[3,c(18:34)])+0.2)
    ...
    plot(forecast_times[18:34],forecast_ys[18:34],type = "n",
         xlab = "",ylab = expression(paste("log(colonies", ~~L^{-1},")")),cex.lab = 2, cex.axis = 2, cex.main = 2,
         ylim = c(-12,10), main = "4 week ahead hindcasts - 2016")
    ciEnvelope(forecast_times[18:34],forecast.ci.IC.P.O.Pa.D[1,c(18:34)],forecast.ci.IC.P.O.Pa.D[3,c(18:34)],col="darkseagreen3")
    ciEnvelope(forecast_times[18:34],forecast.ci.IC.P.O.Pa[1,c(18:34)],forecast.ci.IC.P.O.Pa[3,c(18:34)],col="gold")
    ciEnvelope(forecast_times[18:34],forecast.ci.IC.P.O[1,c(18:34)],forecast.ci.IC.P.O[3,c(18:34)],col="deepskyblue4")
    ciEnvelope(forecast_times[18:34],forecast.ci.IC.P[1,c(18:34)],forecast.ci.IC.P[3,c(18:34)],col="coral")
    ciEnvelope(forecast_times[18:34],forecast.ci.IC[1,c(18:34)],forecast.ci.IC[3,c(18:34)],col="gray")
