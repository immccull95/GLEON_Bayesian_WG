...
#1) Reading in and visualize data (Edit site of interest)
...
#Edit model input names before running model
...
#Model should run as-is without name changes; can alter # of iterations as necessary for convergence
```{r}
...
#Obs. vs. Latent Variable CI Plots: Probably will not need to edit
...
#Diagnostic Visualization: Probably will not need to edit
```{r}
...
#Further Diagnostic Checks and Visualization: Probably will not need to edit
...
#Plots: Probably will not need to edit
